...
As another example, Inigo Quilez created the scene shown below with distance fields which works
in real-time and the [scene](https://www.shadertoy.com/view/ld3Gz2) is available in shadertoy:

<br/>
<ApiImage alt="snail" src="/images/snail-inigo-quilez.png" heigth="100%" width="100%" caption="Snail by Inigo Quilez"/>
<br/>

Another example that I found nice is this galaxy shader by CBS. It makes use of fractals.
